...
sourcePath: /Users/brianwis/.openclaw/workspace/docs/wiki-source/config-podcasts-and-library-paths.md
...
## Source
- Type: `local-file`
- Path: `/Users/brianwis/.openclaw/workspace/docs/wiki-source/config-podcasts-and-library-paths.md`
- Bytes: 5148
