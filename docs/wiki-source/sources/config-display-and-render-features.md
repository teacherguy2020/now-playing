...
sourcePath: /Users/brianwis/.openclaw/workspace/docs/wiki-source/config-display-and-render-features.md
...
## Source
- Type: `local-file`
- Path: `/Users/brianwis/.openclaw/workspace/docs/wiki-source/config-display-and-render-features.md`
- Bytes: 3747
