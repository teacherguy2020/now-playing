---
pageType: source
id: source.source-map
title: source map
sourceType: local-file
sourcePath: /Users/brianwis/.openclaw/workspace/docs/wiki-source/source-map.md
ingestedAt: 2026-04-08T16:01:27.557Z
updatedAt: 2026-04-08T16:01:27.557Z
status: active
---
...
## Source
- Type: `local-file`
- Path: `/Users/brianwis/.openclaw/workspace/docs/wiki-source/source-map.md`
- Bytes: 37434
- Updated: 2026-04-08T16:01:27.557Z
...
- `docs/`
- DeepWiki exports
- this wiki directory (`docs/wiki-source/`)
...
- **moOde box display surfaces** are primarily routed via `display.html`, with concrete display/render modes including Peppy (`peppy.html`, with skin/theme variants inside that mode), Player (`player-render.html` with `player.html` as its designer/preview surface), classic/index display (`index.html`), and a kiosk presentation flow anchored by `kiosk.html`
...
- observed repo nuance: `display.html` is the actual display router, `kiosk.html` redirects into a controller-based kiosk preview flow, `peppy.html` is a dedicated Peppy display/config surface with Peppy skin selection/config implications, and `player.html` is a Player designer/preview surface for `player-render.html`
...
## Related drill-down pages

- `route-ownership-map.md`
- `repo-coverage-notes.md`

`route-ownership-map.md` is the cleaner companion when the question shifts from broad codebase navigation to:
- which route module likely owns a feature
- where to start tracing a behavior from concept into implementation

`repo-coverage-notes.md` is the cleaner companion when the question shifts from codebase navigation to:
- how completely the wiki covers each repo area
- which directories are strongly covered versus only strategically covered
