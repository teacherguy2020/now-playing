...
sourcePath: /Users/brianwis/.openclaw/workspace/docs/wiki-source/user-interfaces.md
...
## Source
- Type: `local-file`
- Path: `/Users/brianwis/.openclaw/workspace/docs/wiki-source/user-interfaces.md`
- Bytes: 8457
